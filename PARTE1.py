...
class_inputKM = input("Insira a Kilometragem percorrida:")
class_inputDAY = input("Insira a quantidade de dias nas quais o carro foi usado:")

if float(class_inputKM) < 0 : 
    print("Kilometragem Inválida")
elif float(class_inputDAY) < 0 :
    print("O carro não pode ser alugado no passado ao presente")
    ...
    if float(class_inputDAY) < 0:
        ...
        output2 = round(x2,3)
        print(output2, "BRL pela Kilometragem que o carro percorreu")
